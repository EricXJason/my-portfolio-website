...
export const Hero = ({ soundPlaying }) => {
  ...
  const currentData = heroData[lang] ?? heroData.zh;
  const { links, contacts } = currentData;
    ...
    >
      ...
      <div className="max-w-7xl 2xl:max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col items-center text-center gap-8 max-w-4xl xl:max-w-5xl mx-auto">
          ...
          >
            <p className="text-xs sm:text-xl lg:text-2xl font-bold font-code tracking-wide bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-500 bg-clip-text text-transparent animate-shimmer-text sm:whitespace-nowrap whitespace-normal text-center break-words leading-relaxed">
              {currentData.subtitle}
            </p>
          </div>

          {/* Bio Overview Text — font-normal/font-medium for high contrast readability */}
          <p
