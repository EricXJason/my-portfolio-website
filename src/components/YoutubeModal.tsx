/**
 * ============================================================================
 * 檔案名稱: YoutubeModal.tsx
 * 所屬模組: Presentation Layer (YouTube 影片展示燈箱模組)
 * 責任描述: 負責呈現專案作品示範影片之 16:9 高畫質 YouTube 嵌入視窗與全螢幕播放。
 * 架構分層: Presentation Layer (React UI Component)
 宣告式模態視窗組件結合 ESC 鍵監聽與自訂游標可見度智慧隔離。
 * 依賴關係: 依賴 ThemeContext 與 Lucide X / Video 圖示。
 * 邊界處理: 關閉時自動卸載 iframe 阻斷背景音訊、自動恢復自訂游標層級。
 * ============================================================================
 */
