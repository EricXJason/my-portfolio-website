        ...
        <div className="space-y-12 max-w-5xl mx-auto">
          {filteredProjects.map((project) => {
            ...
            return (
              <article
                key={project.id}
                className="glass-card rounded-3xl p-6 sm:p-8 border border-[var(--border-color)] flex flex-col lg:flex-row gap-8 items-center group hover:-translate-y-1.5 transition-all duration-500 shadow-lg"
              >
                {/* Left Side: Thumbnail Preview + Direct Action Button */}
                <div className="w-full lg:w-5/12 flex flex-col justify-start gap-4">
                  <div
